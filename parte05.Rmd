...
1. Crie uma consulta para recuperar matrículas dos servidores para quais o valor da rubrica 987 no mês de setembro seja menor do que a mediana para mesmo mês. Use as tabelas  <strong style="color:red;">ERGON.CONS</strong>  e  <strong style="color:red;">ERGON.VINCULOS</strong>. Obs.: A função utilizada para calcular a mediana é a **MEDIAN**.
...
3. Crie uma consulta para recuperar os vínculos mais recentes dos servidores lotados no setor 1. Não use a coluna **DTFIM** na cláusula **WHERE**.
