...
No *Exemplo 5*, a subconsulta destacada retorna a lista de rubricas do fator <strong style="color:red;">'BASE IR'</strong>. Depois, esses valores são usados para restringir os registros da consulta externa.
</br></br>
...
SELECT DISTINCT RUBRICA
FROM ERGON.RUBRICAS
WHERE RUBRICA > 1 AND RUBRICA > 10 AND RUBRICA > 1000
ORDER BY 1;
```
