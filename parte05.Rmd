...
WHERE
  ...
  AND F.VALOR = (
    ...
    FROM #<<
      ...
      ON V.NUMFUNC = F2.NUMFUNC #<<
      AND V.NUMERO = F2.NUMVINC #<<
    WHERE #<<
      V.EMP_CODIGO = 1 #<<
...
No *Exemplo 5*, a coluna *F.NUM_FOLHA* é usada na subconsulta e cada registro da consulta pai é comparado com o resultado da subconsulta.   
]