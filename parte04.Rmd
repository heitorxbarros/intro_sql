...
3. Crie uma consulta para recuperar os nomes do setores em que você já esteve lotado(a), usando as tabelas <strong style="color:red;">ERGON.PROVIMENTOS_EV</strong> e <strong style="color:red;">ERGON.HSETOR_</strong>. Use o seu código **NUMFUNC** ou faça um **JOIN** com a tabela <strong style="color:red;">ERGON.FUNCIONARIOS</strong>.
...
2. Crie uma consulta para recuperar a matrícula, o cargo e o nome do setor dos servidores lotados no setor 1. Use as tabelas <strong style="color:red;">ERGON.VINCULOS</strong>, <strong style="color:red;">ERGON.PROVIMENTOS\_EV</strong>, <strong style="color:red;">ERGON.CARGOS_</strong> e <strong style="color:red;">ERGON.HSETOR_</strong>.
