...
1. Modifique o *Exemplo 5* para exibir o nome da função usando a tabela <strong style="color:red;">ERGON.FUNCOES_EV_</strong>.

2. Crie uma consulta para recuperar
