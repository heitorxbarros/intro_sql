...
---
### WHERE
**Exemplo 7:** Usando **WHERE** com operador lógico **OR** (OU).  
...
---
### WHERE
**Exemplo 8:** Usando **WHERE** com operador lógico **NOT** (NÃO).  
...
---
### WHERE
**Exemplo 9:** Usando **WHERE** com operador lógico **NOT** (NÃO) com mais de uma condição.  
...
---
### WHERE
**Exemplo 10:** Usando **WHERE** com operador de comparação **<>** (diferente de...).
...
.pull-left[
O uso de operadores de comparação nos permite controlar de maneira simples o resultados das consultas. Geralmente, podemos obter o mesmo resultado realizando diferentes consultas. O exemplo acima retorna um resultado igual ao do Exemplo 8.  
]
.pull-right[
```{r echo=FALSE, out.width="100%", fig.align='center', dpi=600}
...
---
### WHERE
**Exemplo 11:** Usando **WHERE** com operador de comparação **>=** (maior ou igual a...).
...
---
### WHERE
**Exemplo 12:** Usando **WHERE** com operador de comparação **BETWEEN** (entre...).
```{sql eval = F}
SELECT DISTINCT MES_ANO_FOLHA, NUM_FOLHA  
FROM ERGON.FICHAS_FINANCEIRAS 
...
---
### WHERE
**Exemplo 13:** Usando **WHERE** com operador de comparação **BETWEEN** (entre...) com dados alfanuméricos.
```{sql eval = F}
...
---
### WHERE
**Exemplo 14:** Usando **WHERE** com operador de comparação **IN** (pertence a...).
```{sql eval = F}
SELECT DISTINCT MES_ANO_FOLHA, NUM_FOLHA  
FROM ERGON.FICHAS_FINANCEIRAS 
...
---
### WHERE
**Exemplo 15:** Usando **WHERE** com operador de comparação **NOT IN** (não pertence a...).
```{sql eval = F}
SELECT DISTINCT MES_ANO_FOLHA, NUM_FOLHA  
FROM ERGON.FICHAS_FINANCEIRAS 
...
---
### WHERE
**Exemplo 16:** Usando **WHERE** com operador de comparação **LIKE**.
```{sql eval = F}
SELECT DISTINCT MES_ANO_FOLHA, NUM_FOLHA  
FROM ERGON.FICHAS_FINANCEIRAS 
