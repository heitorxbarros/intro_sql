...
---
### WHERE
#### **Operadores Lógicos:** São usados para testar a legitimidade de algumas condições. Os operadores lógicos, como operadores de comparação, retornam um tipo de dados Boolean com um valor <strong style="color:red;">TRUE</strong>, <strong style="color:red;">FALSE</strong> ou <strong style="color:red;">UNKNOWN</strong> (verdadeiro, falso ou desconhecido).

---
### WHERE
**Exemplo 7:** Usando WHERE com operadores lógicos.  