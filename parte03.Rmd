...
---
### SYSTEM TABLES
As bases de dados Oracle possuem um grupo especial de tabelas que são criadas durante a instalação do banco. Esse grupo inclui tabelas com metadados e configurações da base de dados.
